...
__decorate([
    swagger_1.ApiProperty({ example: 'Project 1', description: 'Project name' }),
    sequelize_typescript_1.Column({ type: sequelize_typescript_1.DataType.STRING, allowNull: true }),
    __metadata("design:type", String)
], Project.prototype, "name", void 0);
__decorate([
    swagger_1.ApiProperty({ example: 'Project 1', description: 'Project description' }),
...
Project = __decorate([
    sequelize_typescript_1.Table({ tableName: 'projects' })
], Project);
